...
async function checkServerStatus() {
  try {
    ...
    // We will attempt to parse our own data before we save it.
    // This makes it impossible to save corrupted data.
    try {
        JSON.parse(newStatusesString); // Test if the string is valid JSON
        
        // If the line above doesn't throw an error, we save the data.
        await redis.set('serverStatuses', newStatusesString);
        console.log('Successfully wrote clean data to Redis.'); // Success message

    } catch (selfTestError) {
        // If this log ever appears, it will contain the final answer.
